...
export function BrowseEmptyState({ icon, title, description, filledIcon, action, className }: BrowseEmptyStateProps) {
  return (
    <div className={className ?? "mod-card flex flex-col items-center gap-3 rounded-2xl px-6 py-14 text-center"}>
