    ...
    <div className="relative flex h-screen w-full flex-col overflow-hidden">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto pb-20">
          <div className="max-w-[680px] mx-auto px-4 pt-4 flex flex-col gap-4">

            {/* Back */}
            <button onClick={() => router.back()} className="flex items-center gap-1 text-sm self-start" style={{ color: 'var(--neu-text-muted)' }}>
              <span className="material-symbols-outlined text-[18px]">arrow_back</span>
              Help Requests
            </button>

            {/* Main Card */}
            <article className="neu-card-sm rounded-2xl overflow-hidden">
        ...
        <Suspense fallback={<div className="w-80" />}><RightSidebar /></Suspense>
      </div>
      <BottomNav />
    </div>
  );
