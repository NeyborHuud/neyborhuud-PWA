    ...
    return (
      <LocalHuudSubpageShell hubId="jobs">
        <div className="mod-card rounded-2xl p-4 animate-pulse space-y-4">
          <div className="h-8 rounded w-2/3" style={{ background: "var(--neu-shadow-dark)" }} />
          <div className="h-4 rounded w-1/3" style={{ background: "var(--neu-shadow-dark)" }} />
          <div className="flex gap-2">
            <div className="h-6 rounded-full w-24" style={{ background: "var(--neu-shadow-dark)" }} />
            <div className="h-6 rounded-full w-20" style={{ background: "var(--neu-shadow-dark)" }} />
          </div>
          <div className="h-40 rounded-xl" style={{ background: "var(--neu-shadow-dark)" }} />
        </div>
    ...
    return (
      <LocalHuudSubpageShell hubId="jobs">
        <div className="mod-card rounded-2xl p-6 text-center">
          ...
          <button
            onClick={() => router.back()}
            className="px-6 py-3 mod-chip rounded-xl font-semibold transition-colors"
  ...
  return (
    ...
    <LocalHuudSubpageShell hubId="jobs">
          <div className="space-y-4">
            <div className="mod-card rounded-2xl p-6">
              {/* Title + badges */}
            ...
            <p className="text-xs pb-2" style={{ color: "var(--neu-text-muted)" }}>
