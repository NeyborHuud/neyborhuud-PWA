...
function ExplorePageInner() {
  ...
  return (
    <AppBrowseLayout
      header={
        <div className="sticky top-0 z-50 neu-base shrink-0 rounded-2xl border-b border-black/[0.05]" style={{ boxShadow: '0 2px 8px var(--neu-shadow-dark)' }}>
    ...
    >
      {isSearching ? (
        ...
        <div className="w-full">
          ...
          <div className="w-full pt-1 pb-2 flex gap-1.5 overflow-x-auto scrollbar-none items-start">
            {SHORTCUTS.map((s) => (
              <button
                key={s.type}
