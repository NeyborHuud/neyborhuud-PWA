...
function parseScoreTab(value: string | null): Tab {
  if (
    value === "badges" ||
    value === "achievements" ||
    value === "leaderboard" ||
...
export default function HuudScorePage() {
  ...
  useEffect(() => {
    setTab(parseScoreTab(searchParams.get("tab")));
  }, [searchParams]);
  ...
  const changeTab = (id: string) => {
    ...
    router.replace(`/huud-economy/score${qs ? `?${qs}` : ""}`, { scroll: false });
  };
