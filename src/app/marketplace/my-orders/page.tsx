    ...
    <div className="min-h-screen bg-[#0f0f1e] text-white">
      <div className="max-w-4xl mx-auto p-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400 mt-2">Your purchases</p>
        </div>
        ...
        {orders.length === 0 ? (
          <div className="text-center py-12">
            <div className="w-20 h-20 mx-auto mb-4 rounded-full bg-gray-800/50 flex items-center justify-center">
              <span className="material-symbols-outlined text-gray-500 text-[48px]">shopping_bag</span>
            </div>
            <h3 className="text-xl font-semibold mb-2">No Orders Yet</h3>
            <p className="text-gray-400 mb-6">You haven't made any purchases</p>
            <button
